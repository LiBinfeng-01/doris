...
public class DateTimeArithmetic {
     ...
     */
    @ExecFunction(name = "hours_add", argTypes = {"DATE", "INT"}, returnType = "DATETIME")
    ...
    @ExecFunction(name = "hours_add", argTypes = {"DATEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(name = "minutes_add", argTypes = {"DATE", "INT"}, returnType = "DATETIME")
    ...
    @ExecFunction(name = "minutes_add", argTypes = {"DATEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(name = "seconds_add", argTypes = {"DATE", "INT"}, returnType = "DATETIME")
    ...
    @ExecFunction(name = "seconds_add", argTypes = {"DATEV2", "INT"}, returnType = "DATETIMEV2")
