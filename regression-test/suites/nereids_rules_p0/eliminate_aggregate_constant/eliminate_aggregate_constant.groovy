...
suite("eliminate_aggregate_constant") {
    ...
    sql """create table t4 (c3 int, c33 int) distributed by hash(c3) buckets 3 properties('replication_num' = '1');"""
    ...
    qt_basic_4_1 """explain shape plan select max(1) from t4 group by c3;"""
    qt_basic_4_2 """explain shape plan select max(1) from t4;"""
    qt_basic_4_3 """explain shape plan select min(1) from t4 group by c3;"""
    qt_basic_4_4 """explain shape plan select min(1) from t4;"""
    qt_basic_4_5 """explain shape plan select sum(1) from t4 group by c3;"""
    qt_basic_4_6 """explain shape plan select sum(1) from t4;"""
    qt_basic_4_7 """explain shape plan select avg(1) from t4 group by c3;"""
